...
// ตรวจสอบความถูกต้องของลิงก์และ Token
...
if (empty($student_id) || $token !== $valid_token) { 
    die("<h2 style='text-align:center; color:red; margin-top:50px;'>❌ ลิงก์ไม่ถูกต้อง หรือไม่มีสิทธิ์เข้าถึง</h2>"); 
}
...
// ฟังก์ชันสร้าง Header ของมหาวิทยาลัย (ปรับลดขนาดฟอนต์ให้เล็กลงอีก)
function renderHeader() {
    ...
    <div class="uni-header" style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 25px; gap: 20px;">
        ...
        <div class="logo-box" style="flex: 0 0 65px; text-align: center;">
            <img src="logo.jpg" alt="RMUTR Logo" style="width: 58px; height: 102px;">
        </div>
...
// ฟังก์ชันสร้างตารางประเมิน (ปรับฟอนต์ให้เล็กลง)
...
<head>
    ...
    <style>
        /* ลบขอบเริ่มต้นของ Browser เพื่อไม่ให้ดันกระดาษ */
        @page { 
            size: A4; 
            margin: 0; 
        } 
        ...
        /* ตั้งค่าเฉพาะตอนสั่งพิมพ์ (Print) */
        @media print {
            body { 
                background: white; 
                padding: 0; 
            ...
            .a4-page { 
                ...
                box-shadow: none; 
                width: 210mm; 
                height: 297mm; /* บังคับความสูงไม่ให้เกินกระดาษ A4 */
                padding: 10mm 15mm; 
                page-break-after: always; /* บังคับขึ้นหน้าใหม่เสมอเมื่อจบหน้า */
                overflow: hidden; /* ตัดความสูงที่เกินออก ป้องกันหน้ากระดาษแผ่นที่ 5 งอก */
            }
            /* แผ่นสุดท้ายไม่ต้องสั่งขึ้นหน้าใหม่ */
