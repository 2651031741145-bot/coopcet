...
class StudentArchiveDetailScreen extends StatefulWidget {
  final Map<String, dynamic> studentData;

  const StudentArchiveDetailScreen({Key? key, required this.studentData}) : super(key: key);

  @override
  State<StudentArchiveDetailScreen> createState() => _StudentArchiveDetailScreenState();
}

class _StudentArchiveDetailScreenState extends State<StudentArchiveDetailScreen> {
  List<dynamic> _logs = [];
        ...
        : SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // 🚨 นำส่วนการประเมินออกทั้งหมด! แล้วข้ามมาโชว์ประวัติรายวันทันที 🚨
                const SizedBox(height: 25),
